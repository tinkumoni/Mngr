...
public class ClipboardMonitorService extends Service {
    ...
    private static final String FILENAME = "clipboard-history.txt";//"/sdcard/windows/BstSharedFolder/languageoutput/
    ...
    private class WriteHistoryRunnable implements Runnable {
        ...
        public void run() {
            ...
            Toast.makeText(getApplicationContext(), mTextToWrite, Toast.LENGTH_SHORT).show();
